...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "newOwner need to be an address");
        _owner = newOwner;
...
contract Pausable is Ownable {
    ...
    modifier paused() {
        require(_paused, "The contract is unpaused");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner,"This address already the owner of tokenid");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner || isApprovedForAll(owner, msg.sender), "msg need to be owner or isApprovedForAll");
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender, "Address is equal msg.sender");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "From should be owner of given token");
